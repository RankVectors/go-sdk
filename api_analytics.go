...
func (r ApiGetProjectAnalyticsRequest) StartDate(startDate time.Time) ApiGetProjectAnalyticsRequest {
	r.startDate = &startDate
	return r
}

// End date for analytics
func (r ApiGetProjectAnalyticsRequest) EndDate(endDate time.Time) ApiGetProjectAnalyticsRequest {
	r.endDate = &endDate
	return r
}

func (r ApiGetProjectAnalyticsRequest) Execute() (*ProjectAnalytics, *http.Response, error) {
...
*/
func (a *AnalyticsAPIService) GetProjectAnalytics(ctx context.Context, projectId string) ApiGetProjectAnalyticsRequest {
	return ApiGetProjectAnalyticsRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
func (a *AnalyticsAPIService) GetProjectAnalyticsExecute(r ApiGetProjectAnalyticsRequest) (*ProjectAnalytics, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *ProjectAnalytics
	)
	...
	localVarPath := localBasePath + "/api/projects/{projectId}/analytics"
